    ...
    <div class="col-md-12">
        <form action="{{route('product.manage_product_process')}}" method="post" enctype='multipart/form-data'>
            <div class="row">
                ...
                <h2 class="my-3 text-center">Product Images</h2>
                <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="row" id="product_images_box">
                                    ...
                                    <div class="col-md-4 product_images_{{$loop_count_num++}}">
                                        ...
                                        @if($pIArr['images']!='')
                                        <a href="{{asset('storage/media/'.$pIArr['images'])}}" target="_blank"> <img style="width: 100px;height:110px" src="{{asset('storage/media/'.$pIArr['images'])}}"></a>
                                        @endif
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        @if($loop_count_num==2)
                                        <button type="button" class="btn btn-success btn-lg" onclick="add_image_more()"><i class="fa fa-plus"></i>&nbsp; Add more</button>
                                        @else
                ...
                <h2 class="my-3 text-center">Product Attributes</h2>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if($pAArr['attr_image']!='')
                                        <img style="width: 100px;height:110px" src="{{asset('storage/media/'.$pAArr['attr_image'])}}">
                                        @endif
                                    </div>
                                    <div class="col-md-2">
