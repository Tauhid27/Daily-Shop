...
{{session('message')}}
<h1>Category</h1>
<a href="{{url('admin/category/manage_category')}}"><button class="btn btn-success my-3">Add Category</button></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/category/manage_category/')}}/{{$list->id}}"><button class="btn btn-success">Update</button></a>
                            @if($list->status==1)
