                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('admin/product/manage_product/')}}/{{$list->id}}"><button class="btn btn-success">Update</button></a>
                            @if($list->status==1)
                            <a href="{{url('admin/product/status/0')}}/{{$list->id}}"><button class="btn btn-primary">Active</button></a>
